...
<head>
    ...
    <title>Data Materi - House of Learning</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi House of Learning</h2>
                            <hr>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2024 <div class="bullet"></div> <a href="https://github.com/syauqi">Kelompok Pem Web 2</a>
        </div>
    </footer>
    <!-- End Footer -->
