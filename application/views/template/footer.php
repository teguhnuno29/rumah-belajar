    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang House of Learning</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi House of Learning</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak House of Learning</a></li>
                        <li><a href="https://belajar.kemdikbud.go.id/">Website Resmi</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Pengembang Web yang perfeksionis dengan pengalaman satu tahun sebagai Pengembang Web dan Desainer Web. Terampil dalam Mendesain dan mengembangkan Situs Web. Keterampilan komunikasi tertulis dan lisan yang sangat baik; mampu menjelaskan masalah perangkat lunak yang rumit dengan istilah yang mudah dipahami.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang House of Learning</h4>
                <p>
                    Web Edukasi Open Source yang dibuat untuk pelajar. House of Learning adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. House of Learning dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Learnify is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/">Kelompok Pem Web 2 </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-dark font-weight-bold" style="color:#212529 !important;" id="exampleModalCenterTitle">
                    House of Learning - Masuk Sekarang</h2>
